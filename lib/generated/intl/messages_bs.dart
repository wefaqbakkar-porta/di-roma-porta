...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(priceRate, pointRate) => "${priceRate} = ${pointRate} poena";

  static String m6(country) => "${country} zemlja nije podržana";

  static String m7(currency) => "${currency} nije podržan";

  static String m8(day) => "${day} dana prije";

  static String m9(total) => "~${total} km";

  static String m10(timeLeft) => "Završava za ${timeLeft}";

  static String m11(captcha) => "Unesite ${captcha} da potvrdite:";

  static String m12(message) => "Greška: ${message}";

  static String m13(time) => "Ističe za${time}";

  static String m14(total) => ">${total} km";

  static String m15(hour) => "${hour} sati prije";
  ...
  static String m18(size) => "Maksimalna veličina fajla: ${size} MB";

  static String m19(currency, amount) =>
      "Minimalni iznos za korištenje ove uplate je ${currency} ${amount}";

  static String m20(minute) => "${minute} minuta prije";

  static String m21(month) => "${month} mjeseca prije";

  static String m22(store) => "Više od ${store}";

  static String m23(itemCount) => "${itemCount} proizvoda";

  static String m24(price) => "Ukupno opcija: ${price}";

  static String m25(amount) => "Plati ${amount}";

  static String m26(total) => "Količina: ${total}";

  static String m27(percent) => "Rasprodaja ${percent}%";

  static String m28(second) => "${second} sekundi prije";

  static String m29(totalCartQuantity) =>
      "Korpa za kupovinu, ${totalCartQuantity} proizvoda";

  static String m30(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m31(fieldName) => "Polje ${fieldName} je obavezno";

  static String m32(total) => "${total} proizvoda";
  ...
  static String m34(date) => "Validno do ${date}";

  static String m35(message) => "Upozorenje: ${message}";
  ...
  static String m37(length) => "Pronašli smo ${length} proizvoda";

  static String m38(week) => "Sedmica ${week}";

  static String m39(name) => "Dobro došli ${name}";

  static String m40(year) => "${year} godine prije";

  static String m41(total) => "Dodijeljeni ste narudžbi #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addToCartSucessfully":
            MessageLookupByLibrary.simpleMessage("su dodani u vašu korpu"),
        "addToOrder":
        ...
        "productOutOfStock":
            MessageLookupByLibrary.simpleMessage("Proizvoda nema na lageru"),
