...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(country) => "${country} país não é compatível";

  static String m7(currency) => "${currency} não é compatível";

  static String m8(day) => "${day} dias atrás";

  static String m9(total) => "~${total} km";

  static String m10(timeLeft) => "Termina em ${timeLeft}";

  static String m11(captcha) => "Digite ${captcha} para confirmar:";

  static String m12(message) => "Erro: ${message}";

  static String m13(time) => "Expirando em ${time}";

  static String m14(total) => ">${total} km";

  static String m15(hour) => "${hour} horas atrás";
  ...
  static String m18(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m19(currency, amount) =>
      "O valor mínimo para usar este pagamento é ${currency} ${amount}";

  static String m20(minute) => "${minute} minutos atrás";

  static String m21(month) => "${month} meses atrás";

  static String m22(store) => "Mais de ${store}";

  static String m23(itemCount) => " ${itemCount} itens";

  static String m24(price) => "Opções totais: ${price}";

  static String m25(amount) => "Pague ${amount}";

  static String m26(total) => "Qtd: ${total}";

  static String m27(percent) => "Venda ${percent}%";

  static String m28(second) => "${second} segundos atrás";

  static String m29(totalCartQuantity) =>
      "Carrinho de compras, ${totalCartQuantity} itens";

  static String m30(numberOfUnitsSold) => "Vendido: ${numberOfUnitsSold}";

  static String m31(fieldName) => "O campo ${fieldName} é obrigatório";

  static String m32(total) => " ${total} produtos";
  ...
  static String m34(date) => "Válido até ${date}";

  static String m35(message) => "Aviso: ${message}";
  ...
  static String m37(length) => "Encontramos ${length} produtos";

  static String m38(week) => "Semana ${week}";

  static String m39(name) => "Bem-vindo ${name}";

  static String m40(year) => "${year} anos atrás";

  static String m41(total) => "Você atribuiu o pedido nº${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountDeleteDescription": MessageLookupByLibrary.simpleMessage(
            "Excluir sua conta remove informações pessoais de nosso banco de dados."),
        ...
        "addASlug": MessageLookupByLibrary.simpleMessage("Adicionar uma lesma"),
        "addAnAttr":
        ...
        "addToCartSucessfully": MessageLookupByLibrary.simpleMessage(
            "foram adicionados ao seu carrinho"),
        "addToOrder":
        ...
        "bookingError": MessageLookupByLibrary.simpleMessage(
            "Há algo errado. Por favor, tente novamente mais tarde."),
        "bookingHistory":
        ...
        "canNotLaunch": MessageLookupByLibrary.simpleMessage(
            "Não é possível iniciar este aplicativo, verifique se suas configurações no config.dart estão corretas"),
        ...
        "chatViaFacebook": MessageLookupByLibrary.simpleMessage(
            "Converse via Facebook Messenger"),
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("Converse via WhatsApp"),
        "chatWithBot":
        ...
        "clearCart": MessageLookupByLibrary.simpleMessage("Carrinho clara"),
        "clearConversation":
        ...
        "commentSuccessfully": MessageLookupByLibrary.simpleMessage(
            "Comentário com sucesso, por favor aguarde até que seu comentário seja aprovado"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Continue para o pagamento"),
        "continueToReview":
        ...
        "createNewPostSuccessfully": MessageLookupByLibrary.simpleMessage(
            "Sua postagem foi criada com sucesso como um rascunho. Por favor, dê uma olhada em seu site de administração."),
        ...
        "emailDoesNotExist": MessageLookupByLibrary.simpleMessage(
            "A conta de e-mail que você digitou não existe. Por favor, tente novamente."),
        "emailIsRequired": MessageLookupByLibrary.simpleMessage(
            "O campo do email é obrigatório"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("Assinatura de e-mail"),
        "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
            "Parece que você ainda não adicionou nenhum item à sacola. Comece a comprar para preencher."),
        ...
        "emptyWishlistSubtitle": MessageLookupByLibrary.simpleMessage(
            "Toque em qualquer coração ao lado de um produto para adicionar como favorito. Vamos salvá-los para você aqui!"),
        "enableForCheckout":
        ...
        "enterYourPhone": MessageLookupByLibrary.simpleMessage(
            "Coloque seu número de telefone para começar."),
        ...
        "iAgree": MessageLookupByLibrary.simpleMessage("Eu concordo com"),
        ...
        "iwantToCreateAccount":
            MessageLookupByLibrary.simpleMessage("Eu quero criar uma conta"),
        ...
        "lastNameIsRequired": MessageLookupByLibrary.simpleMessage(
            "O campo do sobrenome é obrigatório"),
        "lastTransactions":
        ...
        "loginCanceled":
            MessageLookupByLibrary.simpleMessage("O login foi cancelado"),
        "loginErrorServiceProvider": m16,
        "loginFailed":
            MessageLookupByLibrary.simpleMessage("Falha na autenticação!"),
        "loginInvalid": MessageLookupByLibrary.simpleMessage(
            "Não consigo acessar! Entre em contato com o administrador para verificar sua conta/função."),
        "loginSuccess":
        ...
        "menuOrder": MessageLookupByLibrary.simpleMessage("Ordem do cardápio"),
        ...
        "noConversationDescription": MessageLookupByLibrary.simpleMessage(
            "Ele aparecerá quando seus clientes começarem a conversar com você"),
        ...
        "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
            "Você pode verificar o status do seu pedido usando nosso recurso de status de entrega. Você receberá um e-mail de confirmação do pedido com os detalhes do pedido e um link para acompanhar o andamento."),
        "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
            "Você pode acessar sua conta usando e-mail e senha definidos anteriormente. Na sua conta, você pode editar os dados do seu perfil, verificar o histórico de transações, editar a assinatura do boletim informativo."),
        ...
        "pleaseSignInBeforeUploading": MessageLookupByLibrary.simpleMessage(
            "Faça login em sua conta antes de enviar qualquer arquivo."),
        ...
        "pointMsgOverMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage(
                "Você atingiu o ponto máximo de desconto"),
        ...
        "rateThisAppDescription": MessageLookupByLibrary.simpleMessage(
            "Se você gosta deste aplicativo, reserve um pouco do seu tempo para analisá-lo!\nIsso realmente nos ajuda e não deve levar mais de um minuto."),
        ...
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("Coisas que você pode amar"),
        "releaseToLoadMore":
        ...
        "requestTooMany": MessageLookupByLibrary.simpleMessage(
            "Você solicitou muitos códigos em pouco tempo. Por favor, tente novamente mais tarde."),
        ...
        "scannerLoginFirst": MessageLookupByLibrary.simpleMessage(
            "Para digitalizar um pedido, você precisa primeiro fazer o login"),
        ...
        "transferErrorMessage": MessageLookupByLibrary.simpleMessage(
            "Você não pode transferir para este usuário"),
        "transferFailed":
        ...
        "weWillSendYouNotification": MessageLookupByLibrary.simpleMessage(
            "Enviaremos notificações quando novos produtos ou ofertas estiverem disponíveis. Você sempre pode desativá-lo nas configurações."),
        ...
        "youHavePoints": MessageLookupByLibrary.simpleMessage(
            "Você tem \$ pontos de pontos"),
        "youMightAlsoLike":
            MessageLookupByLibrary.simpleMessage("você pode gostar também"),
        "youNeedToLoginCheckout": MessageLookupByLibrary.simpleMessage(
            "Você precisa fazer login para finalizar a compra"),
        "youNotBeAsked": MessageLookupByLibrary.simpleMessage(
            "Você não será questionado na próxima vez após a conclusão"),
        ...
        "yourBagIsEmpty":
            MessageLookupByLibrary.simpleMessage("Sua bolsa esta vazia"),
        "yourBookingDetail":
